...
fs.writeFile('./_source/_data/function-list.json',buildGlobalsObject(), (err, data)=>{
  if (err) {
    throw err;
  }
});
...
fs.writeFile('./_source/_data/categories.json', JSON.stringify(sortedByCategory, null, 2), (err, data)=>{
  if (err) {
    throw err;
  }
});
