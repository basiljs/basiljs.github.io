...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'lunr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            json = _context.sent;
            // console.log(json);
            idx = !(function webpackMissingModule() { var e = new Error("Cannot find module 'lunr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function () {
              this.ref('id');
              this.field('summary', {
                boost: 5
              });
