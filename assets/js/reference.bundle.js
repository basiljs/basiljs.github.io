...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/src/reference.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var lunr__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lunr */ "./node_modules/lunr/lunr.js");
/* harmony import */ var lunr__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lunr__WEBPACK_IMPORTED_MODULE_2__);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            json = _context.sent;
            // console.log(json);
            idx = lunr__WEBPACK_IMPORTED_MODULE_2___default()(function () {
              this.ref('id');
              this.field('summary');
            ...
            if (searchfield !== null) {
              ...
              searchfield.addEventListener('keyup', function (event) {
                var txt = searchfield.value; // console.log(searchfield.value);

                var results = idx.search(txt); // console.log(results);
                // [...entries].forEach(ele => {
                ...
                if (results.length > 0) {
                  ...
                  container.classList.add('search-result-container'); // console.log(results);

                  results.forEach(function (res) {
                    // if (res.score === 0){
                    //   return;
                    // }
                    var e = document.querySelector("#".concat(res.ref)); // console.log(e);

                    if (e !== null) {
                      container.appendChild(e.cloneNode(true));
                    } else {
                      var matches = json.filter(function (ele) {
                        return ele.id === res.ref;
                      });
